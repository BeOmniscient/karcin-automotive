  ...
  return (
    ...
    >
      <motion.div
        ...
        className="rounded-xl2 border-[2px] border-accent bg-highlight p-8 shadow-card md:p-12"
      >
        {!embedded && (
        ...
        {state === "success" ? (
          ...
          >
            ...
            <fieldset className="md:col-span-2 rounded-xl border-[2px] border-accent bg-secondary/60 p-5">
