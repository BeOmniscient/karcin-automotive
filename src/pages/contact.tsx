  ...
  return (
    <>
      ...
      <section className="container-page pb-24">
        ...
        <div
          id="schedule"
          className="mt-12 rounded-xl2 border border-neutral-dark/10 bg-highlight p-8 text-center shadow-soft md:p-12"
        >
...
function ContactCard({
  ...
  return (
    <a
      href={href}
      className="group flex items-start gap-4 rounded-xl2 border border-neutral-dark/10 bg-highlight p-6 shadow-soft transition-all hover:-translate-y-1 hover:shadow-card"
    >
