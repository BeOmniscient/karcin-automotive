    ...
    <>
      ...
      <section className="container-page">
        <motion.div
          ...
          transition={{ duration: 0.7 }}
          className="rounded-xl2 border-[2px] border-accent bg-highlight px-8 py-20 shadow-card md:px-16 md:py-28"
        >
        ...
        <div className="container-page">
          <div className="grid gap-12 md:grid-cols-[1fr_1.4fr] md:items-center">
            ...
            <div className="space-y-4">
              <div className="rounded-xl2 border-[2px] border-accent bg-highlight px-8 py-12 shadow-soft">
      ...
      <section className="bg-secondary/60 py-20 md:py-28">
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-5 md:grid-cols-2">
            <div className="rounded-xl2 border-[2px] border-accent bg-highlight px-10 py-12 shadow-soft">
      ...
      <section className="container-page py-20 md:py-28">
        ...
        <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
          {palette.map((c) => (
            <div
              key={c.hex}
              className="overflow-hidden rounded-xl2 border-[2px] border-accent bg-highlight shadow-soft"
            >
      ...
      <section className="bg-secondary/60 py-20 md:py-28">
        <div className="container-page">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            <div className="rounded-xl2 border-[2px] border-accent bg-highlight p-10 shadow-soft">
...
function SwatchCard({
  ...
  const bg =
    tone === "primary"
      ...
      ? "bg-neutral-dark"
      : "bg-highlight";
  const border = tone === "light" ? "border-[2px] border-accent" : "";
...
function FaviconPreview() {
  return (
    <div className="rounded-xl2 border-[2px] border-accent bg-highlight p-6 shadow-soft">
  ...
  return (
    <div className="rounded-xl2 border-[2px] border-accent bg-highlight p-6 shadow-soft">
      ...
      <div className="mt-6 space-y-3">
        ...
        <div className="flex aspect-[7/4] flex-col justify-between rounded-lg border-[2px] border-accent bg-highlight p-4">
          <div>
...
function SignaturePreview() {
  return (
    <div className="rounded-xl2 border-[2px] border-accent bg-highlight p-6 shadow-soft">
      ...
      <div className="mt-6 rounded-lg border-[2px] border-accent bg-secondary/60 p-5">
